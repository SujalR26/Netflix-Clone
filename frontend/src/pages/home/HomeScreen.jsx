    ...
    <>
      <div className="relative h-screen text-white ">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32">
          <div className="bg-gradient-to-b from-black/50 via-transparent to-transparent absolute w-full h-full top-0 left-0 -z-10" />
      ...
      <div className="flex flex-col gap-10 bg-black py-10 z-100">
        {contentType==="movie"?(
